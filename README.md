...
Full descriptions of all 47 regulatory flags: [REGULATORY_REFERENCE.md](REGULATORY_REFERENCE.md)
...
> See [CONFORMANCE.md](CONFORMANCE.md) for how to validate your own encoder.
...
The conformance test suite in [CONFORMANCE.md](CONFORMANCE.md)
specifies 20 canonical input/output pairs. A conformant encoder
must produce action decisions that match all 20 cases, with
A4_CLARITY scores within ±0.10 of the reference values.

To list your encoder as conformant, open a pull request per
the instructions in [CONFORMANCE.md](CONFORMANCE.md).
